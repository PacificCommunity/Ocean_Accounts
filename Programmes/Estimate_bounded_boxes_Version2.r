...
##
   ...
   ##
      ...
      rownames(BBX) = NULL
      ##
      ##    I dont know why Fiji screws up - I suspect its because it straddles 180 degrees
      ##
      # BBX$xmin[BBX$Name == "Fiji"] <- st_bbox(st_rotate(Countries[Countries$Name == "Fiji",]))[1]
      # BBX$ymin[BBX$Name == "Fiji"] <- st_bbox(st_rotate(Countries[Countries$Name == "Fiji",]))[2]
      # BBX$xmax[BBX$Name == "Fiji"] <- (-1)*(180+(180 - st_bbox(st_rotate(Countries[Countries$Name == "Fiji",]))[3]))
      # BBX$ymax[BBX$Name == "Fiji"] <- st_bbox(st_rotate(Countries[Countries$Name == "Fiji",]))[4]
      
      BBX$xmin[BBX$Name == "Fiji"] <- st_bbox(st_rotate(Countries[Countries$Name == "Fiji",]))[1] - 180
      BBX$ymin[BBX$Name == "Fiji"] <- st_bbox(st_rotate(Countries[Countries$Name == "Fiji",]))[2]
      BBX$xmax[BBX$Name == "Fiji"] <- st_bbox(st_rotate(Countries[Countries$Name == "Fiji",]))[3] - 180
      BBX$ymax[BBX$Name == "Fiji"] <- st_bbox(st_rotate(Countries[Countries$Name == "Fiji",]))[4]
