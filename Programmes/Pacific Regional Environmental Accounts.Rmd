...
The System of National Accounts (SNA), introduced in 1947, pioneered national accounting: the statistical reporting of a country's economic activity. The metrics reflected the information policy-makers needed to address economic problems from the great 1930 depression, and to finance the Second World War. The concept of a productive "capital stock" to estimate "capital services" used in the economic production process, only formally entered the SNA in 1993. 
