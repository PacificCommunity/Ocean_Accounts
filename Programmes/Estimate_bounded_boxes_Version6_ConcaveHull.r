...
#   for(Country in c("Cook Islands", "Fiji", "Palau", "New Caledonia"))
   ...
   {
      New_Caledonia_Hull <- All_Countries1[All_Countries1$Country == Country,]
...
st_concave_hull(NewCal_Coast, ratio =  0.0009765625)
##
##    TRYING OUT THE CONCAVE HULL
##
   for(Country in c("Cook Islands", "Fiji", "Palau", "New Caledonia"))
   {
