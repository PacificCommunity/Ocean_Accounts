##
##    Programme:  Neural_Net_Version1.r
##
##    Objective:  Builds on of Experiments_in_Tiff3.py
##
##                I've pulled down DEP raw data for lat,lon coordinates:
##                  lower_left = (-22.351142, 166.173569)
##                  upper_right = (-21.895303, 166.932652)
##
##                in what I think is Red, Green and Blue spectrums.
##                Lets try out some of this Keras AI, initially on one layer
##
##
##    Author:     James Hogan, Senior Marine Resource Economist, 5 September 2025
##
##
...
##
   ...
   library(ggplot2)
      ggplot(average_mae_history, aes(x = epoch, y = log(validation_mae))) + 
         geom_line()+         
         geom_smooth()
   ...
   for (i in 1:k) {
     ...
     all_mae_histories <- rbind(all_mae_histories, mae_history)
      ...
      ggplot(all_mae_histories, aes(x = epoch, y = validation_mae)) +    
         geom_smooth()