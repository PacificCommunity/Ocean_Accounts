...
```
   ...
   The GeoMAD data source included a timeseries of spatial data from 2017 to 2024. The logistic regression was only estimated for the 2017 year but applied to the out of sample years to estimate change (Figure \@ref(fig:LandCover))
