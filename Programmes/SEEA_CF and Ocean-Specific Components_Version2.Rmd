...
##
    ...
    FFA_Compendium_of_Economic_and_Development_Statistics_2024 <- FFA_Compendium_of_Economic_and_Development_Statistics_2022  # Fudge factor for being at home
##
...
##
      ...
      License_Revenues <- data.frame(rbind(License_Revenues[order(-License_Revenues$`2021`),],
